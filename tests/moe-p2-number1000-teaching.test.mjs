...
assert.ok(app.includes("'number1000','compareOrder1000','numberPattern1000','oddEven1000'")); assert.ok(app.includes("if(!lessonFirst&&readiness)"),'number1000 must not open with a readiness quiz'); assert.ok(app.includes('lessonTaughtAt'));
