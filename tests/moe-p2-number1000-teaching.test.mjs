...
assert.ok(app.includes("const LESSON_FIRST_SKILLS=new Set(['number1000','compareOrder1000'])")); assert.ok(app.includes("if(!lessonFirst&&readiness)"),'number1000 must not open with a readiness quiz'); assert.ok(app.includes('lessonTaughtAt'));
